...
test("storage_analytics covers summary, duplicates, large_files, file_types, detailed recursion, and version aggregation", async () => {
  ...
  const versionMap: Record<string, any> = {
    "/me/drive/items/file-a/versions": {
      value: [
        { id: "current", size: 200 },
        {
          id: "1.0",
    ...
    "/me/drive/items/file-b/versions": {
      value: [{ id: "current", size: 200 }],
    },
    "/me/drive/items/file-c/versions": {
      value: [
        { id: "current", size: 5 * 1024 * 1024 },
        {
          id: "1.0",
          size: 1024,
          lastModifiedDateTime: "2024-02-01T00:00:00.000Z",
    ...
    "/me/drive/items/file-d/versions": {
      value: [
        { id: "current", size: 1024 },
        {
          id: "1.0",
          size: 512,
          lastModifiedDateTime: "2024-04-01T00:00:00.000Z",
...
test("version_management covers list, restore, delete, cleanup, compare, and invalid action branches", async () => {
            ...
            value: [
              {
                ...
                version: "3.0",
                size: 30,
                lastModifiedDateTime: "2026-04-14T00:00:00.000Z",
              ...
              },
              {
                ...
                version: "2.0",
                size: 20,
                lastModifiedDateTime: "2026-04-13T00:00:00.000Z",
  ...
  let response = (await handleVersionManagement({
  ...
  const restoreMock = createMockGraphClient({
    post: async (endpoint: string) => {
      assert.equal(
        endpoint,
        "/me/drive/items/item-1/versions/2.0/restoreVersion",
      );
      return { success: true };
    },
  });
  ...
  response = (await handleVersionManagement({
    itemId: "item-1",
    action: "restore",
    versionId: "2.0",
  })) as ToolEnvelope;
        ...
        data: {
          value: [
            ...
            },
            {
              ...
              version: "2.0",
              size: 20,
              lastModifiedDateTime: "2026-04-12T00:00:00.000Z",
            },
            {
              id: "1.0",
              version: "1.0",
              size: 10,
              lastModifiedDateTime: "2026-04-11T00:00:00.000Z",
            },
          ],
        },
      };
