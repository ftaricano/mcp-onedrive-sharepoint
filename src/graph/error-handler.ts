  ...
  static categorizeError(code: string, statusCode?: number): ErrorInfo {
    ...
    if (
      ...
      return {
        ...
        isRetryable: false,
        suggestedAction:
          "Check that your app has the required permissions and admin consent",
      };
    }
    ...
    if (
      ...
      return {
        ...
        isRetryable: false,
        suggestedAction:
          "Verify the resource ID/path is correct and the resource exists",
      };
    }
    ...
    if (
      ...
      return {
        ...
        isRetryable: false,
        suggestedAction:
          "Free up storage space or upgrade your Office 365 plan",
      };
    }
    ...
    if (
      ...
      return {
        ...
        isRetryable: true,
        suggestedAction:
          "Resource was modified by another process. Refresh and retry",
      };
    }
    ...
    if (
      ...
      return {
        ...
        isRetryable: true,
        suggestedAction:
          "Microsoft Graph service may be experiencing issues. Try again later",
      };
    }
    ...
    return {
      ...
      isRetryable: false,
      suggestedAction:
        "Review the error details and contact support if the issue persists",
    };
  }
...
export function isAuthenticationError(error: any): boolean {
  const graphError =
    error instanceof GraphApiError ? error : new GraphApiError(error);
